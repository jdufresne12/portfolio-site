        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex flex-col bg-white rounded-lg overflow-hidden shadow-lg">
                ...
                <div className="flex flex-col p-6">
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-4 justify-center items-center mr-5 mt-3 gap-2">
                        {project.technologies.map(tech => (
                            <span key={tech} className="p-2 bg-blue-100 text-blue-800 rounded-full text-xs text-center">{tech}</span>
                        ))}
                    </div>
                </div>
            </div>
