...
export default function Navbar() {
    ...
    const navOptions = ["Home", "About", "Projects", "Contact Me"];
    ...
    return (
        <nav className="fixed top-5 left-13 z-50 w-full ">
            <div className="flex items-center justify-between ">
                ...
                <Menu as="div" ref={menuRef} className="md:hidden inline text-left mr-30">
                    <Menu.Button className="inline-flex justify-center items-center text-xl text-white hover:text-yellow-400" onClick={() => setMenuOpen(!menuOpen)}>
                        <div className="bg-zinc-800 rounded-full shadow-md shadow-stone-700 w-fit flex items-center ">
